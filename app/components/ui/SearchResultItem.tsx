...
export function SearchResultItem({
  ...
  description,
  icon,
  iconBackground = 'bg-unq-elements-background-depth-1/80 dark:bg-unq-elements-background-depth-4/80',
  iconColor = 'text-[var(--unq-elements-item-contentAccent)]',
  tags,
  metadata,
  actionLabel,
  onAction,
  ...
  return (
    <motion.div
      className={classNames(
        'p-5 rounded-xl border border-unq-elements-borderColor dark:border-unq-elements-borderColor-dark hover:border-purple-500/40 transition-all duration-300 shadow-sm hover:shadow-md bg-unq-elements-background-depth-1/50 dark:bg-unq-elements-background-depth-3/50',
    ...
    >
      ...
      {metadata && metadata.length > 0 && (
        <div className="flex flex-wrap items-center gap-3 text-xs text-unq-elements-textTertiary dark:text-unq-elements-textTertiary-dark">
          {metadata.map((item, index) => (
            <div key={index} className="flex items-center gap-1">
              ...
              <span>
                ...
                {item.value !== undefined && (
                  <span className="text-unq-elements-textSecondary dark:text-unq-elements-textSecondary-dark">
                    {item.value}
                  </span>
                )}
              </span>
