      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-unq-elements-textPrimary dark:text-unq-elements-textPrimary-dark'
              : 'text-unq-elements-textSecondary dark:text-unq-elements-textSecondary-dark hover:text-unq-elements-textPrimary dark:hover:text-unq-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-unq-elements-textTertiary dark:text-unq-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
