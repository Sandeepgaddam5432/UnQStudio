  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-unq-elements-borderColor bg-unq-elements-background-depth-1 text-unq-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-unq-elements-textSecondary', className)} {...props} />;
  },
);
