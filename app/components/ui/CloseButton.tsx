  ...
  return (
    <motion.button
      ...
      className={classNames(
        'text-unq-elements-textTertiary hover:text-unq-elements-textSecondary dark:text-unq-elements-textTertiary-dark dark:hover:text-unq-elements-textSecondary-dark',
        'rounded-lg hover:bg-unq-elements-background-depth-2 dark:hover:bg-unq-elements-background-depth-3',
