...
export default function LocalProvidersTab() {
  ...
  const ModelDetails = ({ model }: { model: OllamaModel }) => (
    <div className="flex items-center gap-3 text-xs text-unq-elements-textSecondary">
      <div className="flex items-center gap-1">
        <div className="i-ph:code text-[var(--unq-elements-item-contentAccent)]" />
        <span>{model.digest.substring(0, 7)}</span>
      </div>
      {model.details && (
        <>
          <div className="flex items-center gap-1">
            <div className="i-ph:database text-[var(--unq-elements-item-contentAccent)]" />
            <span>{model.details.parameter_size}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="i-ph:cube text-[var(--unq-elements-item-contentAccent)]" />
  ...
  return (
    <div
      className={classNames(
        'rounded-lg bg-unq-elements-background text-unq-elements-textPrimary shadow-sm p-4',
        'hover:bg-unq-elements-background-depth-2',
        'transition-all duration-200',
      )}
      role="region"
    ...
    >
      ...
      >
        {/* Header section */}
        <div className="flex items-center justify-between gap-4 border-b border-unq-elements-borderColor pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-semibold text-unq-elements-textPrimary">Local AI Models</h2>
              </div>
              <p className="text-sm text-unq-elements-textSecondary">Configure and manage your local AI providers</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-sm text-unq-elements-textSecondary">Enable All</span>
            <Switch
        ...
        {filteredProviders
          ...
          .map((provider) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'bg-unq-elements-background-depth-2 rounded-xl',
                'hover:bg-unq-elements-background-depth-3',
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    className={classNames(
                      ...
                      provider.settings.enabled ? 'text-[var(--unq-elements-item-contentAccent)]' : 'text-unq-elements-textSecondary',
                    )}
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="text-md font-semibold text-unq-elements-textPrimary">{provider.name}</h3>
                      <span className="px-2 py-0.5 text-xs rounded-full bg-green-500/10 text-green-500">Local</span>
                    </div>
                    <p className="text-sm text-unq-elements-textSecondary mt-1">
                ...
                {provider.settings.enabled && (
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      <label className="text-sm text-unq-elements-textSecondary">API Endpoint</label>
                      {editingProvider === provider.name ? (
                        <input
                          ...
                          className={classNames(
                            ...
                            'bg-unq-elements-background-depth-3 border border-unq-elements-borderColor',
                        ...
                        <div
                          ...
                          className={classNames(
                            ...
                            'bg-unq-elements-background-depth-3 border border-unq-elements-borderColor',
                            'hover:border-purple-500/30 hover:bg-unq-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                        >
                          <div className="flex items-center gap-2 text-unq-elements-textSecondary">
              ...
              {provider.settings.enabled && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="i-ph:cube-duotone text-[var(--unq-elements-item-contentAccent)]" />
                      <h4 className="text-sm font-medium text-unq-elements-textPrimary">Installed Models</h4>
                    </div>
                    {isLoadingModels ? (
                      <div className="flex items-center gap-2">
                        <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
                        <span className="text-sm text-unq-elements-textSecondary">Loading models...</span>
                      </div>
                    ) : (
                      <span className="text-sm text-unq-elements-textSecondary">
                    ...
                    {isLoadingModels ? (
                      <div className="space-y-3">
                        {Array.from({ length: 3 }).map((_, i) => (
                          <div
                            key={i}
                            className="h-20 w-full bg-unq-elements-background-depth-3 rounded-lg animate-pulse"
                          />
                        ))}
                      </div>
                    ) : ollamaModels.length === 0 ? (
                      <div className="text-center py-8 text-unq-elements-textSecondary">
                        <div className="i-ph:cube-transparent text-4xl mx-auto mb-2" />
                        <p>No models installed yet</p>
                        <p className="text-sm text-unq-elements-textTertiary px-1">
                          Browse models at{' '}
                          <a
                            href="https://ollama.com/library"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[var(--unq-elements-item-contentAccent)] hover:underline inline-flex items-center gap-0.5 text-base font-medium"
                          >
                            ollama.com/library
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <h5 className="text-sm font-medium text-unq-elements-textPrimary">{model.name}</h5>
                          ...
                          {model.progress && (
                            <div className="mt-3">
                              <Progress
                                ...
                                className="h-1"
                              />
                              <div className="flex justify-between mt-1 text-xs text-unq-elements-textSecondary">
        ...
        <div className="border-t border-unq-elements-borderColor pt-6 mt-8">
          <h3 className="text-lg font-semibold text-unq-elements-textPrimary mb-4">Other Local Providers</h3>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1">
                            ...
                            {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                              <span className="px-2 py-0.5 text-xs rounded-full bg-[var(--unq-elements-button-primary-background)]/10 text-[var(--unq-elements-item-contentAccent)]">
                                Configurable
                              </span>
                            )}
                          </div>
