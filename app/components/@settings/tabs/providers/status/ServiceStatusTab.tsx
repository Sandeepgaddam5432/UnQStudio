  ...
  return (
    <div className="space-y-6">
      ...
      >
          ...
          <div className="flex items-center gap-2">
            <div
              className={classNames(
                ...
                'text-[var(--unq-elements-item-contentAccent)]',
              )}
            >
              <TbActivityHeartbeat className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-md font-medium text-unq-elements-textPrimary">Service Status</h4>
        ...
        <div className="p-4 bg-unq-elements-background-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-unq-elements-textPrimary mb-2">Test API Key</h5>
          <div className="flex gap-2">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-[var(--unq-elements-button-primary-background)] hover:bg-[var(--unq-elements-button-primary-backgroundHover)]',
                'text-white',
                'transition-all duration-200',
                'flex items-center gap-2',
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-unq-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-unq-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-unq-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-unq-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-unq-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {service.incidents && service.incidents.length > 0 && (
                    <div className="mt-2 border-t border-unq-elements-borderColor pt-2">
                      <p className="text-xs font-medium text-unq-elements-textSecondary mb-1">Recent Incidents:</p>
                      <ul className="text-xs text-unq-elements-textTertiary space-y-1">
