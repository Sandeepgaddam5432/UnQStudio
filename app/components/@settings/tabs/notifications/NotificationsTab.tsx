  ...
  const getNotificationStyle = (level: string, type?: string) => {
    if (type === 'update') {
      return {
        ...
        color: 'text-[var(--unq-elements-item-contentAccent)] dark:text-[var(--unq-elements-item-contentAccent)]',
        bg: 'hover:bg-[var(--unq-elements-button-primary-background)]/10 dark:hover:bg-[var(--unq-elements-button-primary-background)]/20',
      };
    }
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        >
          <span className="i-ph:trash text-lg text-gray-500 dark:text-gray-400 group-hover:text-[var(--unq-elements-item-contentAccent)] transition-colors" />
          Clear All
        </button>
      </div>
