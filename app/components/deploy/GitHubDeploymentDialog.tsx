      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw new Error(`Failed to create Git reference: ${createRefError.message || 'Unknown error'}`);
          }
        }
      } catch (gitError) {
        console.error('Error with git operations:', gitError);
        throw new Error(`Failed during git operations: ${gitError.message || 'Unknown error'}`);
      }
