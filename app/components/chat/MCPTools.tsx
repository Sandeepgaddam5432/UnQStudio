...
export function McpTools() {
  ...
  return (
    <div className="relative">
      ...
      <div className="i-unq:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-unq-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-unq-elements-icon-error">{error}</p>}</div>
              </div>
