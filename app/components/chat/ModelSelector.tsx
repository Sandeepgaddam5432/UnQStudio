...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-unq-elements-borderColor bg-unq-elements-prompt-background text-unq-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-unq-elements-borderColor',
            'bg-unq-elements-prompt-background text-unq-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-unq-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-unq-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-unq-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-unq-elements-borderColor bg-unq-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'text-unq-elements-textPrimary placeholder:text-unq-elements-textTertiary',
                    'focus:outline-none focus:ring-2 focus:ring-unq-elements-focus',
                    'transition-all',
                  )}
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-unq-elements-textTertiary" />
                </div>
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-unq-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-unq-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-unq-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-unq-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-unq-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-2 text-sm text-unq-elements-textTertiary">No providers found</div>
              ) : (
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      ...
                      'text-unq-elements-textPrimary',
                      'outline-none',
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-unq-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-unq-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-unq-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-unq-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-unq-elements-borderColor bg-unq-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={classNames(
                      ...
                      'hover:bg-unq-elements-background-depth-3',
                      showFreeModelsOnly
                        ? 'bg-[var(--unq-elements-button-primary-background)]/20 text-[var(--unq-elements-item-contentAccent)] border border-purple-500/30'
                        : 'bg-unq-elements-background-depth-3 text-unq-elements-textSecondary border border-unq-elements-borderColor',
                    )}
                  >
                  ...
                  {showFreeModelsOnly && (
                    <span className="text-xs text-unq-elements-textTertiary">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-2 text-sm text-unq-elements-textTertiary">Loading...</div>
              ) : filteredModels.length === 0 ? (
                <div className="px-3 py-2 text-sm text-unq-elements-textTertiary">
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-unq-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-unq-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {isModelLikelyFree(modelOption, provider?.name) && (
                        <span className="i-ph:gift text-xs text-[var(--unq-elements-item-contentAccent)] ml-2" title="Free model" />
                      )}
                    </div>
                  </div>
                ))
