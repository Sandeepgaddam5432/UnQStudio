      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-unq-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-unq-elements-item-backgroundAccent hover:bg-unq-elements-artifacts-backgroundHover"
